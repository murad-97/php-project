...
<body>
    ...
    <div class="container py-5">
                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            ...
                            <li><a class="text-decoration-none" href="iphone.php">iphone</a></li>
                            <li><a class="text-decoration-none" href="samsung.php">Samsung</a></li>
                            <li><a class="text-decoration-none" href="hawawi.php">Hawawi</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        $sql = "SELECT * FROM product WHERE (product_name LIKE :searchQuery OR discription LIKE :searchQuery) AND category_id = 3";
    ...
    // ********* pagenation *********//
        ...
        $result = $conn->prepare("SELECT * from product WHERE category_id = 3 LIMIT ".$startinglimit. 
        ",". $num_every_page);
        $result->execute();
        $products = $result->fetchAll();
    //********* end pagenation *************//
