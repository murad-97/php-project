...
<body>
    ...
    <div class="container py-5">
        ...
        $sql = "SELECT * FROM product WHERE (product_name LIKE :searchQuery OR discription LIKE :searchQuery) AND category_id = 2";
    ...
    // ********* pagenation *********//
        ...
        $result = $conn->prepare("SELECT * from product WHERE category_id = 2 LIMIT ".$startinglimit. 
        ",". $num_every_page);
        $result->execute();
        $products = $result->fetchAll();
    //********* end pagenation *************//
