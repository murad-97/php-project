...
<head>
  ...
  <title>Mobile-Tech Dashboard | categoriesPage</title>
            ...
            <div class="container">
              ...
              <table class="table" style="width: 100%;">
                ...
                <tbody>
                  ...
                  //display product
                  $pdo = $conn->prepare("SELECT id,name,picture FROM category");
...
<tr> <th>$value[id]</th>
        <td>$value[name]</td>
        <td><img src="./uploads/$value[picture]" alt="image" srcset="" width=70px height=70px> </td>
       <td><a  class="btn btn-primary " href="updatecategory.php?id=$value[id]">Update</a></td>
          <td><a  class="btn btn-primary" href="categories.php?id=$value[id]">Delete</a></td>
...
here;
            ...
            <img src="/Admin/pages/uploads/" alt="" srcset="">
          </div>
        </main>
      </div>
