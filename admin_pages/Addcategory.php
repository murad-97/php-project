...
<head>
  ...
  <title>Mobile-Tech Dashboard | Add categoryPage</title>
    ...
    <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
      ...
      <div class="flex flex-col flex-1 min-h-screen overflow-x-hidden overflow-y-auto">
        ...
        if (!empty($_SERVER["REQUEST_METHOD"] == "POST")) {
          ...
          $main_tmp_category = $_FILES["main-image"]["tmp_name"];
          // print_r($main_tmp);
          // echo"<br>";
          // print_r($main_);
          // echo"<br>";
          $main_size_category = $_FILES["main-image"]["size"];
          ...
          if ($main_size_category > 500000) {
            ...
            ///main_image
            $image_ex = pathinfo($main_image_category, PATHINFO_EXTENSION);
            ...
            if (in_array($image_ex_lc, $allowed_exs)) {
              $new_img_name = $main_image_category;
              ...
              echo "<br>";
              move_uploaded_file($main_tmp_category, $img_upload_path);
            } else {
            }

            $insert = "INSERT INTO category (name,picture) VALUES (:name,:picture)";


            $insertin = $conn->prepare($insert);
            $pdo = $insertin->execute(array(':name' => $name_category, ':picture' => $main_image_category));
