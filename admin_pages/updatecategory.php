...
<html lang="en">
  <head>
    ...
    <title>Mobile-Tech Dashboard | update productPage</title>
    <link
            ...
            <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
              ...
              <div x-data="{ isActive: false, open: false}">
                ...
                <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                 ...
                 <a href="Admin.php" role="menuitem"
                      class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">
                      dashboard
                    </a> <a href="Addproduct.php" role="menuitem"
                      class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">
                      Addprodcut
                    </a>
                    <a href="users.php" role="menuitem"
                      class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">
                      users
                    </a>
...
if (isset($_GET['id'])) {
    ...
    $selectitem="SELECT * FROM category WHERE id=$id"; 
   $result = $conn->prepare($selectitem);
 $result->execute();
       ...
       $main_image_category=$row['picture'];
...
<div class="container">
  ...
  <form action="categories.php"  method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" value="<?php echo htmlspecialchars($name_category)?>" id="name" placeholder="Enter name" name="name">
    </div>
    ...
    <input type="submit" class="btn btn-primary w-full" value="Update" >
